...
function shopingChart() {
  ...
  var storageRead = function storageRead(idAttr) {
  ...
  var storageAdd = function storageAdd(e) {
    e.preventDefault();
  ...
  var resetStorage = function resetStorage(e) {
    e.preventDefault();
    storage.removeAll();
  ...
  var storageCounter = function storageCounter() {
    var storageState = storage.keys().length;
    $('.bought-items').text(storageState);
  };

  var removeBoughtItem = function removeBoughtItem(e) {
    e.preventDefault();
